...
const projects = [
  {
    title: '카드뉴스 디자인',
    tool: ['Illustrator'],
    thumbnail: '/public/cardnews1.jpg',
    preview: '/public/cardnews21.png',
  ...
  },
  {
    title: '모바일 앱 디자인',
    tool: ['Photoshop'],
    thumbnail: '/public/mobile_app1.png',
    preview: '/public/mobile_app2.png',
  ...
  },
  {
    title: '브랜드 홍보 영상',
    tool: ['After Effects'],
    thumbnail: '/public/subway_pc.png',
  ...
  },
  {
    ...
    tool: ['HTML', 'Bootstrap'],
    thumbnail: '/public/antenna_pc.png',
  ...
  },
  {
    ...
    tool: ['Vuetify'],
    thumbnail: '/public/meedream_pc.png',
